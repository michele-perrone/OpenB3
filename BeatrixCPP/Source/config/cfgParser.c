...
static void
formatDoc (const char* modulename, const ConfigDoc* d)
{
...
void
showConfigfileContext (ConfigContext* cfg, const char* msg)
{
	assert (cfg != NULL);
	assert (msg != NULL);
...
void
configIntUnparsable (ConfigContext* cfg)
{
	assert (cfg != NULL);
...
void
configDoubleUnparsable (ConfigContext* cfg)
{
	assert (cfg != NULL);
...
void
configDoubleOutOfRange (ConfigContext* cfg,
                        double         lowest,
                        double         highest)
{
	char buf[256];
...
void
configIntOutOfRange (ConfigContext* cfg, int lowest, int highest)
{
	char buf[256];
	assert (cfg != NULL);
 ...
 */
void
setConfigRangeInt (int* vp, ConfigContext* cfg)
{
	assert (vp != NULL);
	assert (cfg != NULL);
 ...
 */
void
setConfigInt (int* vp, ConfigContext* cfg)
{
	int k;
	assert (vp != NULL);
	assert (cfg != NULL);
 ...
 */
void
setConfigDouble (double* vp, ConfigContext* cfg)
{
	double d;
	assert (vp != NULL);
	assert (cfg != NULL);
 ...
 */
const char*
getConfigValue (ConfigContext* cfg)
{
	return cfg->value;
}
 ...
 */
int
getConfigParameter_ir (const char*    par,
                       ConfigContext* cfg,
                       int*           ip,
                       int            lowInc,
                       int            highInc)
 ...
 */
int
getConfigParameter_dr (const char*    par,
                       ConfigContext* cfg,
                       double*        dp,
                       double         lowInc,
                       double         highInc)
 ...
 */
int
getConfigParameter_fr (const char*    par,
                       ConfigContext* cfg,
                       float*         fp,
                       float          lowInc,
                       float          highInc)
